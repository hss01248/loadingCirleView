...
public class CircleLoadingView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        startColor = typedArray.getColor(R.styleable.CircleLoadingView_loadingview_startColor, 0x88666666);
        endColor = typedArray.getColor(R.styleable.CircleLoadingView_loadingview_endColor, 0x00000000);
        circleThicknessRatio = (float) typedArray.getDimension(R.styleable.CircleLoadingView_loadingview_circleThicknessRatio, 0.1f);
        typedArray.recycle();
        paint = new Paint();
